...
\begin{figure}[H]
  \centering
  \reportfigorplaceholder{scope2.png}{Placeholder: Task 2 (industries) frontiers with three estimators}
...
\begin{figure}[H]
  \centering
  \reportfigorplaceholder{scope3-coal-s2axes.png}{Placeholder: Task 3 with-coal overlay on Scope 2 axis limits}
  \caption{Task 3 (\texttt{with\_coal\_30}): industry vs stock frontiers shown on Scope 2 axis limits.}
  \label{fig:task3_frontiers}
\end{figure}

\begin{figure}[H]
  \centering
  \reportfigorplaceholder{scope3-no-coal-s2axes.png}{Placeholder: Task 3 no-coal overlay on Scope 2 axis limits}
  \caption{Task 3 (\texttt{drop\_coal\_29}): industry vs stock frontiers shown on Scope 2 axis limits.}
...
Using common Scope 2 axis limits, the \texttt{with\_coal\_30} curves appear steeper and further out in mean-vol space, while \texttt{drop\_coal\_29} appears flatter and closer to long-window Scope 2 behavior. This reinforces the interpretation that short-window estimates (with Coal retained) are more sensitive and can overstate tangency performance relative to the longer-window no-coal specification.
